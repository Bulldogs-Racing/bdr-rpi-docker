...
The only limitations here are 1.) storage and 2.) the ability to run Docker. 
Windows Users: please see the windows-release branch on the GitHub page and read THAT documentation instead. This is for MacOS and Linux.
Quickstart 
